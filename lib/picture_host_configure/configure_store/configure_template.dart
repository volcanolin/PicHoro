...
class ConfigureTemplate {
  ...
  static final Map<String, String> awsConfigureTemplate = {for (var k in awsConfigureTemplateKeys) k: placeholder};

  static final Map<String, String> ftpConfigureTemplate = {for (var k in ftpConfigureTemplateKeys) k: placeholder};

  static final Map<String, String> githubConfigureTemplate = {
    for (var k in githubConfigureTemplateKeys) k: placeholder
  };

  static final Map<String, String> imgurConfigureTemplate = {for (var k in imgurConfigureTemplateKeys) k: placeholder};

  static final Map<String, String> lskyproConfigureTemplate = {
    for (var k in lskyproConfigureTemplateKeys) k: placeholder
  };

  static final Map<String, String> qiniuConfigureTemplate = {for (var k in qiniuConfigureTemplateKeys) k: placeholder};

  static final Map<String, String> smmsConfigureTemplate = {for (var k in smmsConfigureTemplateKeys) k: placeholder};

  static final Map<String, String> tencentConfigureTemplate = {
    for (var k in tencentConfigureTemplateKeys) k: placeholder
  };

  static final Map<String, String> upyunConfigureTemplate = {for (var k in upyunConfigureTemplateKeys) k: placeholder};
